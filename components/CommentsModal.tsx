...
export default function CommentsModal({onClose,postId,visible}: CommentsModal) {
  ...
  const handleAddComment = async () => { if (!newComment.trim()) return;
  ...
  return (
   ...
   >
    <View style={styles.modalHeader}>
     <TouchableOpacity onPress={onClose}><Ionicons name="close" size={28} color={COLORS.white} /></TouchableOpacity>
     ...
     <View style={styles.commentInput}>
        ...
        placeholder="Add a comment..." placeholderTextColor={COLORS.grey}
        value={newComment}
