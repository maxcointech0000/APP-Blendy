  ...
  return (
    <View style={styles.container}>
     <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle,{right:100}]} >{profile.username}</Text>
        <View style={{width:24}}/>
     </View>
     <ScrollView showsVerticalScrollIndicator={false}><View style={styles.profileInfo}><View style={styles.avatarAndStats}>
        {/* avatar */}
...
<Text style={styles.statLabel}>Following</Text>
 ...
 <View style={styles.postsGrid}>
    {posts.length === 0 ? (
      ...
      <FlatList data={posts} numColumns={3} scrollEnabled={false} renderItem={({item}) => (
